      ...
      <div className="container mx-auto py-4 px-4 flex justify-between items-center">
        ...
        <div className="flex items-center gap-3">
          <div className="relative h-4 w-6 overflow-hidden rounded-sm">
            <Image src="/bangladesh-flag.jpg" alt="বাংলাদেশের পতাকা" fill className="object-cover" priority />
          </div>

          <div className="hidden md:flex items-center">
            <span className="text-xs bloody-text">ভাষা শহীদদের প্রতি শ্রদ্ধা</span>
          </div>

...
import LanguageMartysTribute from "@/components/language-martyrs-tribute"
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center pt-20 overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden -z-10">
          {Array.from({ length: 12 }).map(
            (
              _,
              i, // Reduced from 20 to 12 for better performance
            ) => (
              <motion.div
                key={i}
                className="absolute rounded-full bg-gradient-to-r from-cyan-300/20 to-blue-300/20 will-change-transform"
                style={{
                  top: `${Math.random() * 100}%`,
          ...
          >
            ...
            >
              <div className="relative h-3 w-5 overflow-hidden rounded-sm">
                <Image src="/bangladesh-flag.jpg" alt="বাংলাদেশের পতাকা" fill className="object-cover" />
              </div>
            ...
            >
              <span className="bg-gradient-to-r from-cyan-500 to-blue-500 bg-clip-text text-transparent drop-shadow-sm">
                প্রগতি
              </span>{" "}
              -
              <br className="md:hidden" /> আপনার কণ্ঠস্বরে চালিত অধ্যয়ন সহকারী
            </motion.h1>
            <motion.p
      ...
      {/* Language Martyrs Tribute */}
      <LanguageMartysTribute />

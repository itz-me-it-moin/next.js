        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-16 bg-blue-50 p-6 rounded-lg">
              <h3 className="text-xl font-semibold mb-4 text-blue-800">প্রকল্প উন্নয়নকারী</h3>
              <p className="text-gray-700 mb-4">
                প্রগতি প্রকল্পটি মইনুল ইসলাম (প্রধান সদস্য, প্রফেশনাল ডেভেলপার, চিফ প্রেজেন্টর) এবং মোঃ থাসেন (সাব ডেভেলপার, প্রশাসনিক
                সদস্য) এর নেতৃত্বে উন্নয়ন করা হয়েছে। শুয়াইবুর রহমান (সাব প্রেজেন্টর, গ্রাফিক্স ডিজাইনার) প্রকল্পের ভিজ্যুয়াল ডিজাইন তৈরি
                করেছেন। লাবিব আহসান (গবেষণা ও ডকুমেন্টেশন বিশেষজ্ঞ) এবং সাজিদুর রহমান (সহকারী গবেষক) প্রকল্পের গবেষণা ও ডকুমেন্টেশন
                তৈরি করেছেন।
              </p>
            </div>
          </div>
